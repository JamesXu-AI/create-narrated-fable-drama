"""Build the postproduction handoff directly from the approved Storyboard."""
...
from narrated_fable_drama.contracts.segment.storyboard import storyboard_segment_rows
...
def load_segment_handoff(task_dir: Path) -> dict[str, dict[str, Any]]:
            ...
            blocks.append(
                {
                    ...
                    "timeline_blocks_source": "storyboard_ordered_shots",
