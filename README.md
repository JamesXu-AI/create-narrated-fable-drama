...
全流程统一执行：少角色、明确对视轴、特写为主。单镜头通常只突出一个核心角色
或一组说话者/听者；角色仍在场不等于必须全员同框。互动开始前先明确双方的银幕
左右、看向与机位所在轴侧，并在正反打中保持一致。默认使用 ECU/CU/MCU；
只有剧情必须看清入场、离场、穿越、靠近、退开、换位或交接落点时，才在该动作
最短可读区间内短暂放宽，动作一落定立即回到关键面部、眼神、嘴部、手/爪、线索
或反应特写。场景开头、环境漂亮、规模宏大、多人仍在现场或追求镜头变化，都不
是放宽景别的理由。
...
2. Storyboard 生成后：全量校验 Storyboard，检查少角色、对视轴、ECU/CU/MCU
   占主导及所有位置变化例外，并按每句精确台词窗口校验语速。
