...
STYLE_AUTHORITY_EN = (
    "Original Soft & Cute 3D Healing Animation; when characters are present, use "
    "a 1:1.5-1:2 large-head compact-body ratio, eyes occupying 25-35% of the face "
    "with controlled highlights, short rounded thick limbs without visible joints, "
    "and full cheeks; bevel and soften all character, costume, prop, furniture, and "
    "architectural forms; use tactile diffuse matte materials with high roughness "
    "for plush/fur/fabric and medium roughness for ceramic/wood, reserving small "
    "specular highlights for physically motivated details; use a 45-degree "
    "front-side soft diffused key with weak opposing fill and no hard rim/back "
    "light; use shallow depth of field equivalent to f/1.8-2.8 while keeping the "
    "acting subject and interaction point sharp; keep a clean warm low-saturation "
    "palette and one readable focal hierarchy; no brand, studio, renderer, artist, "
    "franchise, or IP imitation."
)
