...
from runtime_support import StoryVideoError
from screenplay_contract import load_screenplay_file
...
def validate_character_performance_map(
    ...
    *,
    ...
    for index, (raw, screenplay_segment) in enumerate(
        ...
        # Screenplay authority does not impose provider-era visible-character,
        # silent-group, static-image, or dialogue-turn quotas. Cinematography
        # preserves the authored cast and solves downstream reference/action
        # complexity through layered blocking, approved closed rosters, or
        # motivated Generation-Segment repacking.
